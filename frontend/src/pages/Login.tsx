      ...
      <div className="w-full max-w-md px-6 relative z-10">
        <div className="bg-white/90 backdrop-blur-md rounded-3xl shadow-2xl shadow-stone-400/20 border border-white/60 p-8 sm:p-10">
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-5">
            ...
            <button
              type="submit"
              className="w-full py-3.5 bg-sidebar text-white font-semibold rounded-xl hover:bg-sidebar-hover transition-all shadow-lg hover:shadow-xl hover:shadow-sidebar/25 hover:-translate-y-0.5"
            >
              Sign in
            </button>
          </form>
