          ...
          <header className="flex flex-wrap items-center justify-between gap-3">
            <div className="md:hidden flex items-center justify-between w-full">
              ...
              <button
                type="button"
                onClick={handleLogout}
                className="flex items-center gap-2 px-3 py-2 rounded-xl text-stone-600 hover:bg-stone-100 transition-colors text-sm font-semibold"
              >
                <LogoutIcon />
                Logout
              </button>
            ...
            <div className="flex-1 flex items-center justify-end md:justify-between gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  <span
                    className={`w-1.5 h-1.5 rounded-full ${isVerified ? "bg-accent" : "bg-amber-500"}`}
                  />
